...
Para abrir una cuenta con OCA, tienen que contactarse con Martin Ibarrola o Lorena Marienberg y el se va a encargar de asistirlos con la apertura de cuenta de manera eficaz y práctica.

Adjunto datos de contacto:
Lorena Marienberg lmarienberg@oca.com.ar y Martin Ibarrola mibarrola@oca.com.ar
...
== Video ==
[youtube https://www.youtube.com/watch?v=CS4vVGJfBR8]
...
6) Completa los datos necesarios: el codigo postal de origen, tu CUIT y los Boxsizes con sus respectivas operativas (estos datos se obtienen de OCA).

7) No olvides asignarle las caracteristicas para el envío a tus productos: Peso y dimensiones.
...
* COMPATIBILIDAD CON WOO 8.0


= 1.1.9 =

* COMPATIBILIDAD CON WOO 6.0

= 1.1.8 =

* COMPATIBILIDAD CON WOO 5.8.1

= 1.1.7 =

* COMPATIBILIDAD CON WOO 5.6.1

= 1.1.6 =

* COMPATIBILIDAD CON WOO 5.1.1

= 1.1.5 =

* COMPATIBILIDAD CON WOO 5.0.1

= 1.1.4 =

* COMPATIBILIDAD CON WOO 5.0

= 1.1.3 =

* COMPATIBILIDAD CON WOO 4.3.3

= 1.1.2 =

* COMPATIBILIDAD CON WOO 4.3.1

= 1.1.1 =

* COMPATIBILIDAD CON WOO 4.3

= 1.0.9 =

* COMPATIBILIDAD CON WOO 4.2

= 1.0.8 =

* COMPATIBILIDAD CON WOO 4.0


== Changelog ==
= 1.0.7 =

* COMPATIBILIDAD CON WOO 3.9
